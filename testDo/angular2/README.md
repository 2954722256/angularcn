# 说明
这里是 xls 读取 excel的代码（需要自己修改）

来自于 [js-xlsx](https://github.com/SheetJS/js-xlsx)

的 [angular-xls实现](https://github.com/SheetJS/js-xlsx/tree/master/demos/angular2)

自己基于 angular5 修改 （现在主流版本是 angular6）
